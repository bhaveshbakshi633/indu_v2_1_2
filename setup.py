#!/usr/bin/env python3
"""
NAAMIKA Brain v2.1 Setup Script
============================

This script initializes the NAAMIKA voice assistant system:
...
def check_files():
    ...
    required_files = [
        'server.py',
        'naamika_rag.py',
        'naamika_system_prompt.txt',
        'naamika_knowledge_base.txt',
        'config.json',
        'requirements.txt'
    ]
...
def create_vectorstore():
    ...
    try:
        ...
        vectorstore_path = Path("naamika_vectorstore")
        ...
        agent = NaamikaAgent(debug_mode=False)
...
def main():
    """Main setup function"""
    print_header("NAAMIKA Brain v2.1 Setup")
